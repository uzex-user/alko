...
//
//                graph[in].add(new NodeEdge(out, graph[out].size(), cap));
//                graph[out].add(new NodeEdge(in, graph[in].size() - 1, 0));
//
//                for (int d = 0; d < 4; d++) {
//                    int ni = i + dx[d];
//                    int nj = j + dy[d];
...
//                        graph[out].add(new NodeEdge(neighborIn, graph[neighborIn].size(), INF));
//                        graph[neighborIn].add(new NodeEdge(out, graph[out].size() - 1, 0));
//                    }
//                }
//            }
//        }
...
//        }
//
//        List<NodeEdge> edges = graph[u];
//        for (; ptr[u] < edges.size(); ptr[u]++) {
//            NodeEdge e = edges.get(ptr[u]);
